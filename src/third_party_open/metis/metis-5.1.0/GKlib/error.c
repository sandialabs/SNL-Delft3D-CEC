...
\author George
\date 1/1/2007
\version\verbatim $Id: error.c 51309 2017-06-21 14:06:15Z dam_ar $ \endverbatim
*/
...
{
// NOTE: <arthur.vandam@deltares.nl> disabled the following line, was causing errors on Windows runs.
