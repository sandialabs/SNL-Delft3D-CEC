...
References:
   ...
   2) Unix Programming Frequently Asked Questions: http://www.erlenstar.demon.co.uk/unix/faq_toc.html
"""

__author__ = "Chad J. Schroeder"
__copyright__ = "Copyright (C) 2005 Chad J. Schroeder"
__revision__ = "$Id: daemon.py 62365 2018-10-17 13:40:43Z carniato $"
__version__ = "0.2"
...
def createDaemon(workDir = None):
   """Detach a process from the controlling terminal and run it in the
   background as a daemon.
   """

   if not workDir is None and os.path.isdir(workDir):
       global WORKDIR
       WORKDIR = workDir
   try:
