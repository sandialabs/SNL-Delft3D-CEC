...
// $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/branches/research/Deltares/20160119_tidal_turbines/src/utils_lgpl/esmfsm/packages/esmfsm_version_number/src/c2c.c $
#include <stdlib.h>
#include <stdio.h>
#include <string.h>
