...
!
!-------------------------------------------------------------------------------
!  $Id: ec_module_version.F90.svn 1180 2012-01-13 17:05:48Z mourits $
!  $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/trunk/src/utils_lgpl/ec_module/packages/ec_module/src/ec_module_version.F90.svn $

implicit none

    character(*),  public, parameter :: ec_module_major        = '2'
    character(*),  public, parameter :: ec_module_minor        = '00'
    character(*),  public, parameter :: ec_module_revision     = '00'
    character(*),  public, parameter :: ec_module_build_number = '000000'
