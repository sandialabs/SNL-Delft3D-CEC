...
// $HeadURL: https://svn.oss.deltares.nl/repos/delft3d/branches/research/Deltares/20160119_tidal_turbines/src/tools_gpl/lint/packages/lint_version_number/src/f2c.c $
#include <string.h>
