...
!
!-------------------------------------------------------------------------------
!  $Id: nesthd1_version.F90.svn 1180 2012-01-13 17:05:48Z mourits $
!  $HeadURL:  $
...
implicit none
    ...
    character(*),  public, parameter :: nesthd1_build_number = '000000'

    character(*),  public, parameter :: nesthd1_company      = 'Deltares'
    character(*),  public, parameter :: nesthd1_company_url  = 'http://www.deltares.nl'
