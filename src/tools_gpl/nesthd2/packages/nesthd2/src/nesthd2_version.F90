...
!
!-------------------------------------------------------------------------------
!  $Id: nesthd2_version.F90.svn 1180 2012-01-13 17:05:48Z mourits $
!  $HeadURL:  $

implicit none

    character(*),  public, parameter :: nesthd2_major        = '1'
    character(*),  public, parameter :: nesthd2_minor        = '60'
    character(*),  public, parameter :: nesthd2_revision     = '01'
    character(*),  public, parameter :: nesthd2_build_number = '000000'

    character(*),  public, parameter :: nesthd2_company      = 'Deltares'
    character(*),  public, parameter :: nesthd2_company_url  = 'http://www.deltares.nl'
